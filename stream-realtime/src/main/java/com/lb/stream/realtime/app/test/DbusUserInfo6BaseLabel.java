...
public class DbusUserInfo6BaseLabel {
    ...
    private static final String kafka_cdc_db_topic = Constant.TOPIC_DB;
    ...
    public static void main(String[] args) {
        ...
        DataStreamSource < String > cdcDbMainStream = env
                .fromSource(mySqlSource,WatermarkStrategy.forBoundedOutOfOrderness(Duration.ofSeconds(10)) ,
        ...
        SingleOutputStreamOperator < JSONObject > cdcUserInfoDs = cdcDbMainStream.map(jsonStr -> {
