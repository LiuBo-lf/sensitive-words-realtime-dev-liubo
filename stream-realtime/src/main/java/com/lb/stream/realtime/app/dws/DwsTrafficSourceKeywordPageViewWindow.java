...
import com.lb.stream.realtime.function.KeywordUDTF;
import com.lb.stream.realtime.utils.SQLUtil;
import org.apache.flink.streaming.api.environment.StreamExecutionEnvironment;
import org.apache.flink.table.api.bridge.java.StreamTableEnvironment;

/**
 * @ Package com.lb.stream.realtime.app.dws.DwsTrafficSourceKeywordPageViewWindow
 * @ Author  liu.bo
 * @ Date  2025/5/14 22:26
 * @ description:
 * @ version 1.0
 */
public class DwsTrafficSourceKeywordPageViewWindow {
    public static void main(String[] args) throws Exception {
        ...
        tableEnv.executeSql("create table dws_traffic_source_keyword_page_view_window(" +
                "  stt string, " +  // 2025-05-05 15:15:15
                "  edt string, " +
                "  cur_date string, " +
                "  keyword string, " +
