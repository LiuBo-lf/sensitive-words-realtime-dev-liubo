...
public class BaseApp {
    ...
    private static final String kafka_botstrap_servers = "cdh01:9092,cdh02:9092,cdh03:9092" ;
    ...
    static {
        try {
            ...
            dim_base_categories = JdbcUtils2.queryList2(connection, sql, DimBaseCategory.class, false);
        } catch (Exception e) {
