...
import com.lb.stream.realtime.bean.TableProcessDim;
import com.lb.stream.realtime.utils.HbaseUtils;
...
/**
 * @ Package com.lb.stream.realtime.func.ProcessSpiltStreamToHBaseDimFunc
 * @ Author  liu.bo
 * @ Date  2025/5/14 21:59
 * @ description:
 * @ version 1.0
 */
public class ProcessSpiltStreamToHBaseDimFunc extends BroadcastProcessFunction<JSONObject,JSONObject,JSONObject> {
    ...
    public void open(Configuration parameters) throws Exception {
        Connection connection = JdbcUtils2.getMySQLConnection(
                "jdbc:mysql://cdh03:3306/realtime_v1?",
                "root",
                "root"
        );
        String querySQL = "select * from realtime_v1_config.table_process_dim";
        List<TableProcessDim> tableProcessDims = JdbcUtils2.queryList(connection, querySQL, TableProcessDim.class, true);
        ...
        connection.close();
        hbaseUtils = new HbaseUtils("cdh01:2181,cdh02:2181,cdh03:2181");
