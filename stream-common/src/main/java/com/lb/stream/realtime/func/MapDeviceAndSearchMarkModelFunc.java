...
import com.lb.stream.realtime.base2.DimCategoryCompare;
...
/**
 * @ Package com.lb.stream.realtime.func.MapDeviceAndSearchMarkModelFunc
 * @ Author  liu.bo
...
public class MapDeviceAndSearchMarkModelFunc extends RichMapFunction<JSONObject,JSONObject> {
    ...
    public void open(Configuration parameters) throws Exception {
        connection = JdbcUtils2.getMySQLConnection(
        ...
        dimCategoryCompares = JdbcUtils2.queryList2(connection, sql, DimCategoryCompare.class, true);
